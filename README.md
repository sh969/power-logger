Repo to monitor different power meters like the Shelly EM and the TP-Link Kasa KP115 in the local network and save readings to csv on a Synology using Docker.
